#ifndef		_MODULE_GST_VIDEO_RECEIVER_H_
#define		_MODULE_GST_VIDEO_RECEIVER_H_


#include "../../../../include/ifaces/main/module_iface.h"
#include "GstVideoGraber.h"

class ModuleGstVideoGraber : public FTS::Ifaces::IModule
{
public:
    ModuleGstVideoGraber();
    virtual ~ModuleGstVideoGraber();
...
private:
    ...
    GstVideoGraber *m_pGstVideoGraber;                  //Объект предоставляемого класса
