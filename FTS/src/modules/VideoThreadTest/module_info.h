#ifndef		_VIDEO_THREAD_TEST_INFO_H_
#define		_VIDEO_THREAD_TEST_INFO_H_
...
public:
     ...
     * @return unsigned int
     **/
    virtual unsigned int CALL_CONVERSION GetMajorPartVersion ( void );
     ...
     * @return unsigned int
     **/
    virtual unsigned int CALL_CONVERSION GetMinorPartVersion ( void );
     ...
     * @return unsigned int
     **/
    virtual unsigned int CALL_CONVERSION GetBuildNumber ( void );
     ...
     * @return void
     **/
    virtual void CALL_CONVERSION FillVersionInfo ( FTS::BasesTypes::ShortString* OutVersionInfo );
     ...
     * @return void
     **/
    virtual void CALL_CONVERSION FillModuleReadedName ( FTS::BasesTypes::ShortString* OutReadedModuleName );
     ...
     * @return void
    **/
    virtual void CALL_CONVERSION FillModuleInfo ( FTS::BasesTypes::FullString* OutModuleInfo );
     ...
     * @return unsigned int
    **/
    virtual unsigned int CALL_CONVERSION GetModuleType ( void );
     ...
     * @return void
    **/
    virtual void CALL_CONVERSION FillUsageExtendedLibraryDescriber ( FTS::Ifaces::IUsageLibraryInfoDescriber* OutDescriber );
     ...
     * @return void
    **/
    virtual void CALL_CONVERSION FillExportingInterfacesDescriber ( FTS::Ifaces::IExportInterfaceInfoDescriber* OutDescriber );
     ...
     * @return void
    **/
    virtual void CALL_CONVERSION FillExportingWidgetsDescriber ( FTS::Ifaces::IWidgetInfoDescriber* OutDescriber );
     ...
     * @return void
    **/
    virtual void CALL_CONVERSION FillExportingActionsDescriber ( FTS::Ifaces::IShortStringInfoDescriber* OutDescriber );
     ...
     * @return void
    **/
    virtual void CALL_CONVERSION FillExportingISCParametersDescriber ( FTS::Ifaces::IExportedISCParameters* OutDescriber );
...
#endif		//_VIDEO_THREAD_TEST_INFO_H_
