#ifndef		_VIDEO_THREAD_TEST_EXAMPLE_H_
#define		_VIDEO_THREAD_TEST_EXAMPLE_H_


#include "../../../../include/ifaces/main/module_iface.h"
#include "VideoThreadTest.h"

class ModuleVideoThreadTest : public FTS::Ifaces::IModule
{
public:
    ModuleVideoThreadTest();
    virtual ~ModuleVideoThreadTest();
...
private:
    ...
    VideoThreadTest *m_pVideoThreadTest;                                //Объект предоставляемого класса
...
#endif		//_VIDEO_THREAD_TEST_EXAMPLE_H_
